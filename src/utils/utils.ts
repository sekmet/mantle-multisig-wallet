...
export const getNetworkNameByChainId = (chainId: string) => {
  ...
  switch (String(chainId)) {
    ...
    case '82':
      ...
      break;
    case '83':
      result = 'meter-testnet';
      break;
    case '5001':
      result = 'mantle-testnet';
      break;
...
export const getProviderByChainId = (chainId: string) => {
  ...
  switch (chainId) {
    ...
    case '1313161555':
      ...
      break;
    case '83':
      result = process.env.METERTESTNET_NETWORK_PROVIDER;
      break;
    case '82':
      result = process.env.METER_NETWORK_PROVIDER;
      break;
    case '5001':
      result = process.env.MANTLETESTNET_NETWORK_PROVIDER;
      break;
  ...
  switch (String(chainId)) {
    ...
    case '82':
      result = {
        id: 82,
        name: 'Meter',
        thumbnail: '/assets/images/meter.jpg',
      };
      break;
    case '83':
      result = {
    ...
    case '5001':
      result = {
        id: 5001,
        name: 'Mantle Testnet',
        thumbnail: '/assets/images/mantle.jpg',
      };
      break;
